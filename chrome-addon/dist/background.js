...
function getBookmarks(port, { args }) {
    ...
    chrome.bookmarks.getRecent(maxInput ? maxInput : constants_1.MAX_BOOKMARK_COUNT)
...
function processChunk(items) {
    return __awaiter(this, void 0, void 0, function* () {
        const bms = [];
        for (const p of (yield getBmParentTitles(items.filter(item => item.url !== undefined)))) {
            bms.push({
                id: p.id,
                title: p.title,
                url: p.url,
...
function getTabs(port, { command: _cmd }) {
    chrome.tabs.query({})
        .then((chromeTabs) => __awaiter(this, void 0, void 0, function* () {
